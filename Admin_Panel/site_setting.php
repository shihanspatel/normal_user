...
include('index.php');
?>
<link rel="stylesheet" href="/Admin_Panel/Files/bootstrap.min.css">
<script src="/Admin_Panel/Files/bootstrap.bundle.min.js"></script>
<script src="/Admin_Panel/Files/jquery-3.7.1.min.js"></script>
<script src="/Admin_Panel/Files/jquery.validate.min.js"></script>
...
<div class="col-xxl-9" style="margin: auto;">
    <div class=" shadow-sm p-4">
        ...
        <button class="dark-mode-toggle btn btn-light mb-3" onclick="toggleDarkMode()">🌙 Toggle Dark Mode</button>
